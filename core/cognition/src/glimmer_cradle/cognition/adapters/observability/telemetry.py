...
1. **薄门面**：不重写底层模块（logger/metrics/tracer），只是把它们的公开 API
   集中到 ``glimmer_cradle.cognition.adapters.observability`` 命名空间，调用方一个 import 就够。
...
# ── metrics 支柱 ② ────────────────────────────────────────────────────────────
from glimmer_cradle.cognition.adapters.observability.metrics import (
    MetricKind,
    counter,
    gauge,
    histogram,
...
# ── traces 支柱 ③ ─────────────────────────────────────────────────────────────
from glimmer_cradle.cognition.adapters.observability.tracer import (
    SpanEvent,
    span,
    start_tracer,
    stop_tracer,
