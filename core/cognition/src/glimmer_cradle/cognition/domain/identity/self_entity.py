...
class KnowledgeModule(Protocol):
...
class SelfEntity:
    ...
    def __init__(
        self,
        manifest_config: CharacterManifestSettings | None = None,
        inference_config: InferenceSettings | None = None,
        profile_config: CharacterProfileSettings | None = None,
        dialogue_config: DialoguePolicySettings | None = None,
        ...
        # 冻结的核心配置，会话期不可修改
        # ======================================
        self.manifest_config: Final[CharacterManifestSettings] = manifest_config
        self.profile_config: Final[CharacterProfileSettings] = profile_config
        self.dialogue_config: Final[DialoguePolicySettings] = dialogue_config
        self.safety_config: Final[SafetySettings] = safety_config
        self.inference_config: Final[InferenceSettings] = inference_config
