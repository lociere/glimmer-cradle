...
用法:
  ...
  python core/cognition/tools/experience.py show <trace_id>
  python core/cognition/tools/experience.py causes <moment_id>
  python core/cognition/tools/experience.py kinds
...
def main() -> int:
    ...
    if command == "tail":
        ...
        if not args:
            print("用法: python core/cognition/tools/experience.py show <trace_id>")
            return 2
        cmd_show(base_dir, args[0])
    elif command == "causes":
        if not args:
            print("用法: python core/cognition/tools/experience.py causes <moment_id>")
            return 2
