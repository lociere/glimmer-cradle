...
用法：
  python core/kernel/tools/telemetry.py metrics tail [N]     最近 N 条 metric
  python core/kernel/tools/telemetry.py metrics names
  python core/kernel/tools/telemetry.py metrics grep <name>
  python core/kernel/tools/telemetry.py spans tail [N]
  python core/kernel/tools/telemetry.py spans latest
  python core/kernel/tools/telemetry.py spans tree <trace_id>
  python core/kernel/tools/telemetry.py spans slowest [N]
"""
