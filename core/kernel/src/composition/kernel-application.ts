 ...
 * `core/runtime/modules/*` 这些 app-root delegate，避免根入口退化成长脚本。
 */
...
import { closeLogger, getLogger } from '../adapters/observability/logger';
import { histogram } from '../adapters/observability/metrics';
...
export class App {
  ...
  public async start(): Promise<void> {
    ...
    try {
      ...
      const foundationRuntime = new KernelBootstrapRuntime();
