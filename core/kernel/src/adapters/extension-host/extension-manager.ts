...
} from '../extension-installation/extension-package-manager';
...
import { resolveConfigPath, resolveConfiguredProjectPath } from '../filesystem/path-utils';
...
import { ExtensionProcessHost } from './extension-process-host';
import { currentExtensionPlatform } from '../platform/skill-availability';
...
export class ExtensionManager {
  ...
  public constructor(
    ...
    private readonly readinessProjection: RuntimeProjectionInputPort,
  ...
  private syncRuntimeReadiness(): void {
    this.readinessProjection.replaceModuleSnapshots('extension-runtime', this.getReadinessSnapshots());
  }
