...
interface ConversationHistoryCognitionPort {
  getConversationHistory(request: ConversationHistoryRequest, traceId?: string): Promise<CognitionHistoryResponse>;
}
...
export class ConversationHistoryService {
  ...
  public constructor(
    private readonly conversationDirectory: ConversationDirectoryPort,
    private readonly cognition: ConversationHistoryCognitionPort,
  ) {}
  ...
  public async readHistory(request: ConversationHistoryQuery): Promise<ConversationHistoryResponse> {
    ...
    const persisted = await this.cognition.getConversationHistory(payload, request.request_id);
  ...
  private resolveConversation(traceId: string) {
