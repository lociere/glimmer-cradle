...
const FRAME_CLASS_BY_KIND: Record<PresentationFrameKind, PresentationFrameClass> = {
  ...
  conversation_notice: 'presentation_state',
  conversation_history_result: 'presentation_state',
  skill_catalog_response: 'presentation_state',
  configuration_snapshot_result: 'presentation_state',
  configuration_update_result: 'presentation_state',
  configuration_test_result: 'presentation_state',
