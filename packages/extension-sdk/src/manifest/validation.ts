...
import ExtensionManifestSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-manifest.schema.json';
import ExtensionPermissionSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-permission.schema.json';
import CapabilityScopeSchema from '@glimmer-cradle/contracts/json-schema/common/v1/capability-scope.schema.json';
import ExtensionPackageChecksumsSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-package-checksums.schema.json';
import ExtensionPackageEnvelopeSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-package-envelope.schema.json';
import ExtensionRegistryCatalogSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-registry-catalog.schema.json';
import ExtensionReleaseManifestSchema from '@glimmer-cradle/contracts/json-schema/extension/v1/extension-release-manifest.schema.json';
import { isSafeExtensionPackagePath } from '../distribution/package-format';
