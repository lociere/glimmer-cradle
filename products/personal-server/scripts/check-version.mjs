...
const expectedFacts = [
  ...
  ['hosts/unity-avatar-host/Assets/Scripts/GlimmerCradle/Host/UnityAvatarHostConfig.cs', `hostVersion = "${rootVersion}"`],
  ['hosts/unity-avatar-host/Assets/Scripts/GlimmerCradle/Host/AvatarProtocolClient.cs', `hostVersion = "${rootVersion}"`],
  ['hosts/unity-avatar-host/Assets/Scenes/UnityAvatarHost.unity', `hostVersion: ${rootVersion}`],
