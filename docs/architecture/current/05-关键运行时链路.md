...
> 事实依据：Kernel lifecycle、Cognition Service、Desktop UI controller、Audio runtime、Avatar、Skill Plane 与 Protocol 实现。
> 维护触发：生命周期阶段、Ingress Gate、gRPC/IPC/WS/stdio 契约、Surface 投影、Skill Plane 调用或 Avatar/Audio 主链变化。
