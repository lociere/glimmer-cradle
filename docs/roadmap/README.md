...
M12 Contract Spine/runtime 物理重建与 M13 A～F/最终仓库工具收口均已完成。M11 已进入前端实现，Shell/Router、概览、对话、能力、活动与设置 React slice 已落地；Extension/NapCat 与生产验收仍未完成。当前切片与验收状态由 [now.md](./now.md) 维护。
